...
from api.resources.quote import QuoteResource, QuoteListResource, QuotesByAuthorsResource, QuotesChangeRate
...
api.add_resource(QuotesChangeRate, "/quotes/<int:quote_id>/<type>")
